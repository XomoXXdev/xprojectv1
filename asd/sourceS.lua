-- NOTE: Change these mysql informations to your own
local host = "127.0.0.1"
local username = "root"
local password = "tamitamika"
local database = "xproject"
...
function loadFarmFromDatabase(dbID)
  ...
  if farmQuery then
    for k, v in pairs(farmQuery) do
      ...
      farmInteriors[dbID] = createObject(16671, worldX+3.1-0.60, worldY+3.45, 4.4)
