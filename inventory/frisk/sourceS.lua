func.frisk.requestItems = function(target)
	...
	local targetDatas = {
		money = getElementData(target,"player:money");
...
func.frisk.deleteItem = function(element,data,state,playerSource)
	--outputAdminMessage("törölte #db3535"..getItemName(tonumber(data.item),tostring(data.value)).." #557ec9-ból/ből #db3535"..tonumber(data.count).."#557ec9db-ot #db3535"..string.gsub(getPlayerName(element), "_", " ").."#557ec9-tól/től.")
