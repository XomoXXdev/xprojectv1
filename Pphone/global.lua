...
options = {
    {name = "Háttérkép", desc = "", icon = "back.png", type = "menu"},
	{name = "Csengőhang", desc = "", icon = "ringstone.png", type = "menu"},
	{name = "Értesítési hang", desc = "", icon = "ringstone.png", type = "menu"},
	{name = "Biztonság", desc = "", icon = "privacy.png", type = "menu"},
    --{name = "Dark Mode", desc = "", icon = "darkmode.png", type = "on/off"},
}
...
homeScreenFontColors = {
	...
	{tocolor(255, 255, 255, 255), tocolor(255, 255, 255, 255)},
	{tocolor(255, 255, 255, 255), tocolor(255, 255, 255, 255)},
	{tocolor(255, 255, 255, 255), tocolor(255, 255, 255, 255)}, -- 17

	{tocolor(255, 255, 255, 255), tocolor(255, 255, 255, 255)}, -- 18
	{tocolor(255, 255, 255, 255), tocolor(255, 255, 255, 255)}, -- 19 
	{tocolor(255, 255, 255, 255), tocolor(255, 255, 255, 255)}, -- 20 
	{tocolor(255, 255, 255, 255), tocolor(255, 255, 255, 255)}, -- 21 

	{tocolor(0, 0, 0, 255), tocolor(255, 255, 255, 255)}, -- 22
	{tocolor(255, 255, 255, 255), tocolor(255, 255, 255, 255)}, -- 23
	{tocolor(255, 255, 255, 255), tocolor(255, 255, 255, 255)}, -- 24 
	{tocolor(255, 255, 255, 255), tocolor(255, 255, 255, 255)}, -- 25 
	{tocolor(255, 255, 255, 255), tocolor(255, 255, 255, 255)}, -- 26 
	{tocolor(0, 0, 0, 255), tocolor(0, 0, 0, 255)}, -- 27 

	{tocolor(0, 0, 0, 255), tocolor(255, 255, 255, 255)}, -- 28 
	{tocolor(255, 255, 255, 255), tocolor(255, 255, 255, 255)}, -- 29 
	{tocolor(255, 255, 255, 255), tocolor(255, 255, 255, 255)}, -- 30 
}
...
Menus911 = {
	{"Metropolitian Police", 1, "pd"},
	{"Sheriff's Department", 2, "sheriff"},
	{"Medical Services", 3, "medic"},
	{"Mechanic Center", 4, "mechanic"},
}
