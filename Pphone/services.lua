...
local fonts = {
    ["bebasneue-20"] = dxCreateFont("files/fonts/sf_ui_display/thin.ttf", 15),
    ["condensed-12"] = dxCreateFont("files/fonts/sf_ui_display/thin.ttf", 15),
    ["fontawesome-30"] = dxCreateFont("files/fonts/sf_ui_display/thin.ttf", 15),
}
...
function drawPanel()
    ...
    dxDrawText(phoneServices[selectedService].name.." #ffffff- xProject", sx*0.39, sy*0.315, sx*0.39+sx*0.1, sy*0.315+sy*0.04, tocolor(phoneServices[selectedService].color[2], phoneServices[selectedService].color[3], phoneServices[selectedService].color[4], 255*pAlpha), 0.85/myX*sx, fonts["bebasneue-20"], "left", "top", false, false, false, true)
